...
export class AnnouncementsComponent {
  ...
  @Select(ClassState.selectAnnouncements) announcements$!: Observable<any>;
}
...

{
  ...
  },
  {
    ...
    description: "Realizați o compoziție plastică în care să redați atmosfera sărbătorilor de iarnă, și în care să aveți ca element principal un felinar.",
